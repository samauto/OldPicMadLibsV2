...
private let SQLITE_FILE_NAME = "PicMadLibs.sqlite"
private let DATA_MODEL_NAME = "PicMadLibs"
...
class CoreDataStackManager {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        ...
        //DEBUG print("Instantiating the applicationDocumentsDirectory property")
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        //DEBUG print("Instantiating the managedObjectModel property")
        
        let modelURL = NSBundle.mainBundle().URLForResource(DATA_MODEL_NAME, withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        //DEBUG print("Instantiating the persistentStoreCoordinator property")
        
        let coordinator: NSPersistentStoreCoordinator? = NSPersistentStoreCoordinator(managedObjectModel: self.managedObjectModel)
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent(SQLITE_FILE_NAME)
        
        //DEBUG print("sqlite path: \(url.path!)")
